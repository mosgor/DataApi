...
class ProcessedData(_message.Message):
    ...
    def __init__(self, source_id: _Optional[int] = ..., model_id: _Optional[int] = ..., data_json: _Optional[str] = ..., arrival_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
